      ...
      ecosystems: {
        ...
        list: [
          ...
          },
          {
            ...
            description: "Presidente do CGBW na América",
            image: americacgbw,
          },
          {
            name: "Sindiswa Mzamo",
            description: "Presidente Global do Circle of Global Business Women",
            image: SINDI,
          },
        ],
      },
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start mb-4 mt-[-40px] md:items-stretch">
          <div>
            ...
            <div className="bg-amber-900 p-6 rounded-lg shadow-md mt-28 mb-28">
              <p className="text-lg italic text-orange-100 leading-relaxed">
                {t.mission}
              </p>
            </div>

            <h3 className="text-xl font-bold mt-24 mb-6 text-gray-900">
              {t.projects.title}
            </h3>
            ...
            <div className="text-center mt-8">
              <a
                href="https://www.linkedin.com/company/circle-of-global-business-women-cgbw/posts/?feedView=all"
                target="_blank"
