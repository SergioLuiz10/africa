...
const Contact: React.FC<ContactProps> = ({ language }) => {
  ...
  return (
    <section id="contact" className="py-20 bg-amber-900">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <form className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-amber-50 mb-1">{t.name}</label>
                <input
                  type="text"
                  id="name"
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-amber-50 mb-1">{t.email}</label>
                <input
                  type="email"
                  id="email"
                  className="w-full px-4 py-3 border border-amber-300 rounded-lg bg-[#f4e3d7] text-gray-900 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-amber-50 mb-1">{t.message}</label>
                <textarea
                  id="message"
                  rows={5}
                  className="w-full px-4 py-3 border border-amber-300 rounded-lg bg-[#f4e3d7] text-gray-900 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors"
          ...
          <div className="space-y-8">
            <div className="bg-amber-100 p-6 rounded-lg shadow-sm border border-amber-300">
              <div className="flex items-start">
                <MapPin className="text-orange-600 mr-4 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-bold text-orange-700 mb-1">{t.address}</h3>
                  <p className="text-amber-900">{t.addressText}</p>
                </div>
              </div>
            </div>
